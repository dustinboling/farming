  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved farm as @farm" do
        ...
        post :create, {:farm => { "name" => "invalid value" }}, valid_session
        assigns(:farm).should be_a_new(Farm)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested farm" do
        ...
        Farm.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => farm.to_param, :farm => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the farm as @farm" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Farm.any_instance.stub(:save).and_return(false)
        put :update, {:id => farm.to_param, :farm => { "name" => "invalid value" }}, valid_session
        assigns(:farm).should eq(farm)
      end
